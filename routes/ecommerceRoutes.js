...
module.exports.setRouter = function(app) {
  ...
  let baseurl1 = appConfig.apiVersion + '/cart';
   ...
   app.get(baseurl +'/listAll', auth.isAuthenticate, eController.getAllProducts);
   /**
	 ...
	 */
   app.post(baseurl + '/create', auth.isAuthenticate, eController.createProduct);
   ...
   * @apiParam {String}  quantity   quantity of the  product passed as a body parameter
   ...
   app.get(baseurl + '/view/:productId',  auth.isAuthenticate, eController.getSingleProduct);
   /**
   ...
   app.post(baseurl + '/delete/:productId' ,auth.isAuthenticate, eController.deleteProduct );
    /**
	 ...
	 */
   app.put(baseurl + '/edit/:productId', auth.isAuthenticate, eController.editProduct );
         /**
	 ...
	 */
    app.post(baseurl1 +'/add/:productId',  auth.isAuthenticate, eController.addToCart);
    /**
   ...
   app.post(baseurl1 + '/remove/:productId', auth.isAuthenticate, eController.removeFromCart);
    /**
	 ...
	 */
   app.get(baseurl1 +'/listAll',auth.isAuthenticate, eController.getAllCartProducts);
/**
